      ...
      <div className="w-full flex flex-col pt-24 md:pt-28 pb-12 overflow-hidden relative gap-y-10">
        ...
        <div className="2xl:container 2xl:mx-auto grid grid-cols-1 px-4 md:px-20 pb-16">
          ...
          <p className="text-[32px] font-medium text-[#DEAC80] text-center">
            This project is a reflection of myself, encapsulating my
            personality, interests, and experiences. Through this website,
            visitors will gain insights into who I am, my passions, and the work
            I've done. Every aspect of this portfolio is meticulously crafted to
            showcase not just my skills but also my unique identity. From the
            design elements to the content, each detail is a deliberate choice
            that represents me authentically. This website serves as both a
            professional showcase and a personal statement, allowing others to
            connect with me on a deeper level and understand what drives me
